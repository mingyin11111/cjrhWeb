              ...
              <table style="width: 100%;">
                <tr>
                  <td style="width: 150px;height: 150px;">
                    <img @click="ViewResource(item)" v-if="item.Attachment.length > 0"
                      :src="item.Attachment.split('*')[0]" style="cursor: pointer; width: 150px;height: 150px;">
                  </td>
                  <td valign="top">
                    <span @click="ViewResource(item)"
                      style="display: flex ;padding:10px;font-size: 16px;font-weight: bold;overflow: hidden;cursor: pointer;">
                      {{ item.Title }}
                    </span>
                    <div
