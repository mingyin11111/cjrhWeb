                        ...
                        <div style="padding: 10px;">
                            ...
                            <div style="background-color: antiquewhite;margin-top: 15px;padding: 10px;">
                                <div style=" text-align: center;padding: 20px;">
                                    更新日期：{{ formatDate(schoolModel.updatedAt) }}
                                 </div>
                            </div>
                            <div>
                                <div style="padding: 10px; word-break: break-all;">{{ schoolModel.Memo }}</div>
                            </div>
                        </div>
                    </el-card>
      ...
      return t.getFullYear() + "-" + (t.getMonth() + 1) + "-" + (t.getDate()) + " " + (t.getHours()) + ":" + t.getMinutes() + ":" + t.getMinutes();
        ...
        GetInformationDetail(ID) {
            ...
            this.$axios({
                ...
                .then((res) => {
                    if (res.data.err == 0) {
                        this.schoolModel = res.data.data;
                        this.loading = false;
                        // this.getNeedModel(this.schoolModel.NeedID);
                    }
                    else {
                        this.$message.error("错误：" + res.data.err);
                    }
