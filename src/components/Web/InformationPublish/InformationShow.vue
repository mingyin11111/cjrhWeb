            ...
            <el-row>
                <el-col :span="24">
                    ...
                    <el-tabs v-model="activeName" @tab-click="ChangeTab" >
                        ...
                        <el-tab-pane label="成员-学校" name="成员-学校">
                            <el-row :gutter="12">
                            <el-col :span="12"  v-for="item in pageinfo.PageData" :key="item.id" style="margin-bottom: 10px;">
                                <el-card shadow="hover"  >
                                    <table>
                                        <tr>
                                            <td valign="top">
                                                <img :src="item.Logo" style="cursor: pointer;;width: 200px;height: 150px;" @click="ToInformationDetail_School(item)">
                                            </td>
                                            <td valign="top" style="padding: 10px;">
                                                <div style=" cursor: pointer;font-size: 16px;font-weight: bold;margin-bottom: 10px;" @click="ToInformationDetail_School(item)">{{item.Name}}</div>
                                                <span style="font-size: 14px;  color: dimgray; height: 110px; display: block; overflow: hidden;">{{item.Memo}}</span>
                                            </td>
                                        </tr>
                                    </table>
                                </el-card>
                        ...
                        <el-tab-pane label="成员-企业" name="成员-企业">
                            <el-row :gutter="12">
                            <el-col :span="12"  v-for="item in pageinfo.PageData" :key="item.id" style="margin-bottom: 10px;">
                                <el-card shadow="hover"  >
                                    <table>
                                        <tr>
                                            <td valign="top">
                                                <img :src="item.Logo" style="cursor: pointer;;width: 200px;height: 150px;" @click="ToInformationDetail_Company(item)">
                                            </td>
                                            <td valign="top" style="padding: 10px;">
                                                <div style=" cursor: pointer;font-size: 16px;font-weight: bold;margin-bottom: 10px;" @click="ToInformationDetail_Company(item)">{{item.Name}}</div>
                                                <span style="font-size: 14px;  color: dimgray; height: 110px; display: block; overflow: hidden;">{{item.Memo}}</span>
                                            </td>
                                        </tr>
                                    </table>
...
export default {
    ...
    methods: {
        ...
        changePage(p) {
            ...
            else  if(this.activeName== '成员-企业')
            {
                this.GetInUnitCompanyList(p);
            }
            else{
